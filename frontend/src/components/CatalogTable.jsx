...
export default function CatalogTable({ subjects, electives, institutional, onEdit }) {
  ...
  return (
    <div className="mx-auto max-w-[1550px] px-4 py-6 sm:px-6 lg:px-8">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><p className="text-xs font-semibold uppercase tracking-[0.16em] text-blue-700">Catálogo académico</p><h2 className="mt-1 text-2xl font-bold tracking-tight text-slate-950">Asignaturas y optativas</h2><p className="mt-2 text-sm text-slate-500">Consulta atributos académicos, ciclos disponibles e identificadores especiales.</p></div><button type="button" onClick={() => onEdit(null)} className="flex h-10 items-center justify-center gap-2 rounded-xl bg-[#A6192E] px-4 text-xs font-semibold text-white"><Icon name="plus" size={15} /> Nueva asignatura</button></div>
